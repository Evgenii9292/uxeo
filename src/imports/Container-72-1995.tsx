...
import svgPaths from "./svg-d909h6dj22";
...
function Frame9() {
  return (
    <div className="flex-[1_0_0] h-[247.152px] min-h-px min-w-px relative rounded-[24px]" data-name="Frame" style={{ backgroundImage: "linear-gradient(137.629deg, rgba(58, 81, 67, 0.5) 2.4187%, rgba(56, 72, 62, 0.5) 98.527%, rgba(45, 56, 44, 0.5) 116.25%)" }}>
...
function Frame24() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start justify-center relative shrink-0 w-[254px]" data-name="Frame">
      <Frame25 />
      <p className="font-['Roboto_Condensed:Regular',sans-serif] font-normal leading-[1.2] relative shrink-0 text-[#cdf6db] text-[16px] w-[271px]">Основная кнопка имеет высокий контраст и лучше выделяется, поэтому интерфейс читается быстрее.</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[30px] items-center pb-[30px] pt-[40px] relative rounded-[24px] shrink-0 w-full" data-name="Frame">
      <Frame7 />
      <Frame8 />
      <Frame23 />
    </div>
...
function Container16() {
  return (
    <div className="bg-[#374348] relative rounded-[24px] shrink-0 w-full" data-name="Container">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-center px-[20px] relative w-full">
          <Container17 />
          <Frame5 />
        </div>
      </div>
