import svgPaths from "./svg-5p8ld1ssfi";
...
function Container() {
  return (
    <div className="bg-[#343e42] h-[100px] relative rounded-[15px] shrink-0 w-full" data-name="Container">
...
function Frame10() {
  return (
    <div className="col-1 ml-[186.07px] mt-[15px] relative row-1 size-[18.007px]" data-name="Frame">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.0067 18.0067">
        <g clipPath="url(#clip0_283_1749)" id="Frame">
          <g id="Vector" />
          <path d={svgPaths.p3561f00} fill="var(--fill-0, #364146)" id="Vector_2" />
        </g>
        <defs>
          <clipPath id="clip0_283_1749">
            <rect fill="white" height="18.0067" width="18.0067" />
          </clipPath>
        </defs>
      </svg>
...
function Frame4() {
  return (
    <div className="flex-[1_0_0] h-[405px] min-h-px min-w-px relative rounded-[20px]" data-name="Frame" style={{ backgroundImage: "linear-gradient(117.673deg, rgba(58, 81, 67, 0.5) 2.4187%, rgba(56, 72, 62, 0.5) 98.527%, rgba(45, 56, 44, 0.5) 116.25%)" }}>
  ...
  return (
    <div className="col-1 ml-[12.53px] mt-[14.74px] relative row-1 size-[17.688px]" data-name="Frame">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.6876 17.6876">
        <g clipPath="url(#clip0_283_1743)" id="Frame">
          <g id="Vector" />
...
function Frame17() {
  return (
    <div className="col-1 ml-[182.77px] mt-[14.74px] relative row-1 size-[17.688px]" data-name="Frame">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.6876 17.6876">
        <g clipPath="url(#clip0_283_1728)" id="Frame">
          <g id="Vector" />
  ...
  return (
    <div className="relative shrink-0 size-[27px]" data-name="free-icon-party-popper-7626666 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 27 27">
        <g clipPath="url(#clip0_283_1797)" id="free-icon-party-popper-7626666 1">
...
function Group78() {
  return (
    <div className="absolute contents left-[283.01px] top-[110.71px]">
      <div className="absolute h-[58.308px] left-[284.91px] top-[113.18px] w-[103.945px]">
        <div className="absolute inset-[-1.61%_-0.85%_-1.61%_-0.25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 105.086 60.1851">
            <path d={svgPaths.p1bf5ab80} fill="var(--stroke-0, #798589)" id="Vector 733" />
          </svg>
        </div>
      </div>
...
function Group76() {
  return (
    <div className="absolute contents left-[112.42px] top-[20px]">
      <div className="absolute h-[84.27px] left-[112.42px] top-[20.05px] w-[254.893px]">
        <div className="absolute inset-[-0.86%_-0.34%_-1.18%_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 255.908 85.9926">
            <path d={svgPaths.p249cc4f0} fill="var(--stroke-0, #798589)" id="Vector 731" />
          </svg>
        </div>
      </div>
      <div className="absolute h-[81px] left-[114px] top-[20px] w-[114px]">
        <div className="absolute inset-[-0.16%_0_-1.11%_-0.62%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 114.599 82.0323">
            <path d={svgPaths.p1edd9f80} fill="url(#paint0_linear_283_1795)" id="Vector 735" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_283_1795" x1="48.6867" x2="17.6323" y1="34.8484" y2="104.513">
          ...
          <div className="h-[76px] relative w-[127px]">
            <div className="absolute inset-[-0.17%_0.13%_-1.11%_-0.56%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 127.549 76.9723">
                <path d={svgPaths.p36475680} fill="url(#paint0_linear_283_1631)" id="Vector 736" />
                <defs>
                  <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_283_1631" x1="54.1639" x2="28.3813" y1="32.7069" y2="101.38">
                    <stop stopColor="#FF6B21" />
                    <stop offset="1" stopColor="#994014" />
                  </linearGradient>
                </defs>
...
function Group77() {
  return (
    <div className="absolute contents left-[112px] top-[110.43px]">
      <div className="absolute h-[61.965px] left-[112px] top-[110.43px] w-[159.857px]">
        <div className="absolute inset-[0_-0.55%_-1.28%_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 160.765 62.7394">
            <path d={svgPaths.p3c2ba480} fill="var(--stroke-0, #798589)" id="Vector 732" />
          </svg>
        </div>
      </div>
...
function Group79() {
  return (
    <div className="absolute contents left-[112px] top-[20px]">
      <Group78 />
      <Group76 />
      <Group77 />
    </div>
...
function Frame29() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[20px] w-full">
      <Group79 />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Zap Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Zap Icon">
          <path d={svgPaths.p3b6e5180} fill="url(#paint0_linear_283_1673)" id="Vector" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_283_1673" x1="10.5745" x2="0.899453" y1="10.5727" y2="24.4536">
            <stop stopColor="#FF6B21" />
            <stop offset="1" stopColor="#994014" />
          </linearGradient>
        </defs>
  ...
  return (
    <div className="relative rounded-[27.3px] shrink-0" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center relative">
        <div className="relative shrink-0 size-[38.999px]" data-name="free-icon-book">
...
function Link2() {
  return (
    <div className="relative rounded-[27.3px] shrink-0" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center relative">
        <div className="relative shrink-0 size-[38.999px]" data-name="free-icon-emblem">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
...
function Link3() {
  return (
    <div className="relative rounded-[27.3px] shrink-0" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center relative">
        <div className="relative shrink-0 size-[38.999px]" data-name="free-icon-user">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
...
function Icon() {
  return (
    <div className="absolute h-[83px] left-[458px] shadow-[0px_20px_50px_0px_#2d363a] top-[1025px] w-[77px]" data-name="Icon">
      <EllipseContainer />
      <IconContainer />
    </div>
  );
...
function Container29() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#ff5d39] content-stretch flex gap-[6.678px] h-[68px] items-center justify-center left-[calc(50%-126px)] pl-[25.835px] pr-[30.835px] py-[15.835px] rounded-[24px] top-[1025px] w-[255px]" data-name="Container">
...
function Icon1() {
  return (
    <div className="absolute h-[83px] left-[455px] shadow-[0px_20px_50px_0px_#2d363a] top-[942px] w-[77px]" data-name="Icon">
      <EllipseContainer2 />
      <FreeIconGift />
    </div>
  );
...
export default function Phone() {
  return (
    <div className="bg-[#2d363a] relative size-full" data-name="Phone">
      ...
      <div className="absolute h-[292px] left-[-383px] top-[1032px] w-[1270px]">
        <div className="absolute inset-[-34.25%_-7.87%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1470 492">
            <g filter="url(#filter0_f_283_1618)" id="Ellipse 383">
              <ellipse cx="735" cy="246" fill="var(--fill-0, #2D363A)" rx="635" ry="146" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="492" id="filter0_f_283_1618" width="1470" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_283_1618" stdDeviation="50" />
              </filter>
            </defs>
          </svg>
        </div>
