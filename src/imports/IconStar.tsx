import svgPaths from "./svg-kzxviuq4he";

export default function IconStar() {
  return (
    <div className="relative size-full" data-name="Icon/Star">
      <div className="absolute h-[22.726px] left-[2px] top-[1.32px] w-[22.66px]">
        <div className="absolute h-[22.726px] left-0 top-0 w-[22.66px]">
