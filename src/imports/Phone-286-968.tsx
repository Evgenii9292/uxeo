import svgPaths from "./svg-y8wgo586bv";
      ...
      <div className="absolute h-[81px] left-[114px] top-[20px] w-[114px]">
        <div className="absolute inset-[-0.16%_0_-1.11%_-0.62%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 114.599 82.0323">
            <path d={svgPaths.p167f4780} fill="url(#paint0_linear_286_1153)" id="Vector 735" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_286_1153" x1="48.6867" x2="17.6323" y1="34.8484" y2="104.513">
          ...
          <div className="h-[76px] relative w-[127px]">
            <div className="absolute inset-[-0.17%_0.13%_-1.11%_-0.56%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 127.549 76.9723">
                <path d={svgPaths.p3eb0ef00} fill="url(#paint0_linear_286_1159)" id="Vector 736" />
                <defs>
                  <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_286_1159" x1="54.1639" x2="28.3813" y1="32.7069" y2="101.38">
                    <stop stopColor="#FF6B21" />
                    <stop offset="1" stopColor="#994014" />
                  </linearGradient>
                </defs>
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Zap Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Zap Icon">
          <path d={svgPaths.p3b6e5180} fill="url(#paint0_linear_286_1142)" id="Vector" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_286_1142" x1="10.5745" x2="0.899453" y1="10.5727" y2="24.4536">
            <stop stopColor="#FF6B21" />
            <stop offset="1" stopColor="#994014" />
          </linearGradient>
        </defs>
