import svgPaths from "./svg-mfoan0qzpw";
import imgFrame481335 from "figma:asset/97093ea9d460d45781036b2e265f35ee47e147a7.png";
...
import img202603032301004 from "figma:asset/4c9055e86ba753d88dd53fb36b42956d50e57429.png";
import img202603032301005 from "figma:asset/a64b8bc1ef2b29d6bc1363aa0e7f6bd70ea7e926.png";
import img202603032301006 from "figma:asset/167c3efca727ac3b6f8b0c3a6d089184601162f9.png";

function Container() {
  return (
    <div className="content-stretch flex items-start px-[15px] relative shrink-0 w-[125px]" data-name="Container">
...
function Group() {
  return (
    <div className="absolute inset-[13.46%_6.25%]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.75 13.1558">
        <g id="Group">
          <path d={svgPaths.p21be0800} fill="var(--fill-0, #F4F5FC)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function FreeIconTelegram() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="free-icon-telegram-4701496 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <Group />
      </div>
    </div>
...
function Container1() {
  return (
    <div className="bg-[#404d52] content-stretch flex gap-[10px] h-[40.962px] items-center justify-center px-[9.231px] relative rounded-[13.846px] shrink-0" data-name="Container">
      <FreeIconTelegram />
...
function Container2() {
  return (
    <div className="bg-[#404d52] content-stretch flex h-[40.962px] items-center justify-center px-[9.231px] relative rounded-[13.846px] shrink-0" data-name="Container">
      <p className="font-['Roboto_Condensed:Bold',sans-serif] font-bold leading-[15.865px] relative shrink-0 text-[18.462px] text-[rgba(244,245,252,0.4)] whitespace-nowrap">Сообщить об ошибке</p>
    </div>
  );
}
...
function FooterContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[15px] items-start relative shrink-0 w-full" data-name="Footer Container">
      <Link />
      <Container1 />
      <Container2 />
    </div>
...
function Frame53() {
  return (
    <div className="h-[13.702px] relative shrink-0 w-full">
...
function Frame54() {
  return (
    <div className="content-stretch flex flex-col h-[1110px] items-start justify-between relative shrink-0 w-full">
      <Frame52 />
      <Frame57 />
    </div>
  );
...
function Frame55() {
  return (
    <div className="absolute content-stretch flex flex-col h-[1150px] items-start left-[12px] max-h-[2000px] pl-[12px] pr-[11px] py-[20px] rounded-[24px] top-[20px] w-[238px]">
  ...
  return (
    <div className="relative shrink-0" data-name="Back Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative">
        <p className="font-['Roboto_Condensed:Bold',sans-serif] font-bold leading-[27.5px] relative shrink-0 text-[#f4f5fc] text-[26px] whitespace-nowrap">Курсы</p>
      </div>
    </div>
  );
}
    ...
    <div className="absolute inset-[0_15.69%]" data-name="Fire Icon Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.7655 24.4324">
        <g id="Fire Icon Group">
          <path d={svgPaths.p33094f0} fill="url(#paint0_linear_118_1312)" id="Vector" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_118_1312" x1="8.38273" x2="8.38273" y1="0" y2="24.4324">
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Zap Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Zap Icon">
          <path d={svgPaths.p3b6e5180} fill="url(#paint0_linear_118_1339)" id="Vector" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_118_1339" x1="10.5745" x2="0.899453" y1="10.5727" y2="24.4536">
  ...
  return (
    <div className="relative shrink-0" data-name="Zap Icon Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center relative">
        <ZapIcon />
        <p className="bg-clip-text font-['Roboto_Condensed:ExtraBold',sans-serif] font-extrabold leading-[21px] relative shrink-0 text-[24px] text-[transparent] whitespace-nowrap" style={{ backgroundImage: "linear-gradient(181.068deg, rgb(255, 107, 33) 43.49%, rgb(193, 92, 42) 97.541%)" }}>{`1250 `}</p>
      </div>
    </div>
  );
}
...
function ProgressIndicator() {
  return <div className="bg-gradient-to-b flex-[1_0_0] from-[#ff6b21] min-h-px min-w-px rounded-[24px] to-[#994014] w-[137px]" data-name="Progress.Indicator" />;
}

function ProgressRoot() {
  return (
    <div className="bg-[#404d52] content-stretch flex flex-col h-[9px] items-start overflow-clip pl-[-111.75px] pr-[111.75px] relative rounded-[16777200px] shrink-0 w-full" data-name="Progress.Root">
      <ProgressIndicator />
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="absolute content-stretch flex flex-col items-center justify-center left-[37px] top-[12px] w-[112px]">
      <ProgressRoot />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="bg-[#38444a] flex-[1_0_0] min-h-px min-w-px relative rounded-[24px] w-[185px]">
      <div className="absolute h-[97px] left-[33px] top-[33px] w-[120px]" data-name="Снимок экрана 2026-03-03 в 23.01.00 3">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[114.82%] left-[-22.73%] max-w-none top-[-3.8%] w-[145.46%]" src={img202603032301003} />
        </div>
      </div>
      <Frame6 />
    </div>
...
function Frame11() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Roboto_Condensed:Bold',sans-serif] font-bold leading-[27.5px] relative shrink-0 text-[#f4f5fc] text-[28px] whitespace-nowrap">{`UX/UI `}</p>
    </div>
  );
}
...
function Group2() {
  return (
    <div className="absolute inset-[22.57%_5.88%_15.9%_5.88%]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.9997 9.23063">
        <g id="Group">
          <path d={svgPaths.p1f3ddd00} fill="var(--fill-0, #61737A)" id="Vector" />
          <path d={svgPaths.p1dcc7b80} fill="var(--fill-0, #F1F2FB)" id="Vector_2" />
          <path d={svgPaths.p36483400} fill="var(--fill-0, #61737A)" id="Vector_3" />
        </g>
      </svg>
    </div>
  );
...
function Group1() {
  return (
    <div className="absolute contents inset-[22.57%_5.88%_15.9%_5.88%]" data-name="Group">
      <Group2 />
    </div>
  );
}

function FreeIconVolumeLevelIndicator() {
  return (
    <div className="h-[15px] overflow-clip relative shrink-0 w-[17px]" data-name="free-icon-volume-level-indicator-65061 1">
      <Group1 />
    </div>
  );
}
...
function FreeIconLayer() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="free-icon-layer-1694011 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_118_1334)" id="free-icon-layer-1694011 1">
          <path d={svgPaths.p32f7ef00} fill="var(--fill-0, #F1F2FB)" id="Vector" />
          <path d={svgPaths.p223b500} fill="var(--fill-0, #F1F2FB)" id="Vector_2" />
          <path d={svgPaths.p36804e00} fill="var(--fill-0, #F1F2FB)" id="Vector_3" />
        </g>
        <defs>
...
function Frame8() {
  return (
    <div className="content-stretch flex gap-[5px] items-center justify-center relative shrink-0">
      <FreeIconLayer />
      <p className="font-['Roboto_Condensed:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#f1f2fb] text-[16px] whitespace-nowrap">5 модулей</p>
    </div>
  );
}

function FreeIconLayer1() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="free-icon-layer-1694011 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_118_1334)" id="free-icon-layer-1694011 1">
...
function Frame12() {
  return (
    <div className="content-stretch flex gap-[5px] items-center justify-center relative shrink-0">
      <FreeIconLayer1 />
      <p className="font-['Roboto_Condensed:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#f1f2fb] text-[16px] whitespace-nowrap">24 урока</p>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="content-center flex flex-wrap gap-[5px_21px] items-center relative shrink-0 w-full">
      <Frame10 />
      <Frame8 />
      <Frame12 />
    </div>
...
function Container3() {
  return (
    <div className="bg-[#404d52] content-stretch flex gap-[8px] h-[55px] items-center justify-center px-[16px] relative rounded-[20px] shrink-0 w-[210px]" data-name="Container">
...
function Link1() {
  return (
    <div className="bg-[#343e42] content-stretch flex flex-col h-[199px] items-center p-[20px] relative rounded-[24px] shrink-0 w-[572px]" data-name="Link">
...
function Frame2() {
  return (
    <div className="bg-[#38444a] flex-[1_0_0] min-h-px min-w-px relative rounded-[24px] w-[185px]">
      <div className="absolute h-[91px] left-[53px] opacity-60 top-[34px] w-[80px]" data-name="Снимок экрана 2026-03-03 в 23.01.00 2">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function Frame19() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Roboto_Condensed:Bold',sans-serif] font-bold leading-[27.5px] relative shrink-0 text-[#798489] text-[28px] whitespace-nowrap">Figma PRO</p>
    </div>
  );
}
...
function Group4() {
  return (
    <div className="absolute inset-[22.57%_5.88%_15.9%_5.88%]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.9997 9.23063">
        <g id="Group">
          <path d={svgPaths.p1f3ddd00} fill="var(--fill-0, #798489)" id="Vector" />
          <path d={svgPaths.p1dcc7b80} fill="var(--fill-0, #798489)" id="Vector_2" />
          <path d={svgPaths.p36483400} fill="var(--fill-0, #61737A)" id="Vector_3" />
        </g>
      </svg>
    </div>
...
function FreeIconVolumeLevelIndicator1() {
  return (
    <div className="h-[15px] overflow-clip relative shrink-0 w-[17px]" data-name="free-icon-volume-level-indicator-65061 1">
      <Group3 />
    </div>
...
function Frame21() {
  return (
    <div className="content-stretch flex gap-[5px] items-center justify-center relative shrink-0">
      <FreeIconVolumeLevelIndicator1 />
      <p className="font-['Roboto_Condensed:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#798489] text-[16px] whitespace-nowrap">мидл</p>
    </div>
  );
}

function FreeIconLayer2() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="free-icon-layer-1694011 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_118_1307)" id="free-icon-layer-1694011 1">
          <path d={svgPaths.p32f7ef00} fill="var(--fill-0, #798489)" id="Vector" />
          <path d={svgPaths.p223b500} fill="var(--fill-0, #798489)" id="Vector_2" />
          <path d={svgPaths.p36804e00} fill="var(--fill-0, #798489)" id="Vector_3" />
        </g>
        <defs>
          <clipPath id="clip0_118_1307">
            <rect fill="white" height="14" width="14" />
          </clipPath>
        </defs>
      </svg>
...
function Frame9() {
  return (
    <div className="content-stretch flex gap-[5px] items-center justify-center relative shrink-0">
      <FreeIconLayer2 />
      <p className="font-['Roboto_Condensed:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#798489] text-[16px] whitespace-nowrap">4 модуля</p>
    </div>
  );
}

function FreeIconLayer3() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="free-icon-layer-1694011 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_118_1307)" id="free-icon-layer-1694011 1">
...
function Frame22() {
  return (
    <div className="content-stretch flex gap-[5px] items-center justify-center relative shrink-0">
      <FreeIconLayer3 />
      <p className="font-['Roboto_Condensed:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#798489] text-[16px] whitespace-nowrap">24 урока</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="bg-[#343e42] content-stretch flex h-[55px] items-center justify-center px-[17px] py-px relative rounded-[24px] shrink-0 w-[210px]" data-name="Container">
      ...
      <p className="font-['Roboto_Condensed:Bold',sans-serif] font-bold leading-[27.5px] relative shrink-0 text-[#798589] text-[22px] whitespace-nowrap">В разработке</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="bg-[#38444a] flex-[1_0_0] min-h-px min-w-px relative rounded-[24px] w-[185px]">
      <div className="absolute h-[91px] left-[53px] opacity-60 top-[34px] w-[80px]" data-name="Снимок экрана 2026-03-03 в 23.01.00 2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img202603032301004} />
      </div>
    </div>
  );
}
...
function Frame26() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Roboto_Condensed:Bold',sans-serif] font-bold leading-[27.5px] relative shrink-0 text-[#798489] text-[28px] whitespace-nowrap">ИИ для дизайнеров</p>
    </div>
  );
}
...
function FreeIconVolumeLevelIndicator2() {
  return (
    <div className="h-[15px] overflow-clip relative shrink-0 w-[17px]" data-name="free-icon-volume-level-indicator-65061 1">
      <Group5 />
    </div>
...
function Frame28() {
  return (
    <div className="content-stretch flex gap-[5px] items-center justify-center relative shrink-0">
      <FreeIconVolumeLevelIndicator2 />
      <p className="font-['Roboto_Condensed:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#798489] text-[16px] whitespace-nowrap">новичек</p>
    </div>
  );
}

function FreeIconLayer4() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="free-icon-layer-1694011 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_118_1307)" id="free-icon-layer-1694011 1">
...
function Frame4() {
  return (
    <div className="bg-[#38444a] flex-[1_0_0] min-h-px min-w-px relative rounded-[24px] w-[185px]">
      <div className="absolute h-[95px] left-[51px] opacity-60 top-[32px] w-[84px]" data-name="Снимок экрана 2026-03-03 в 23.01.00 2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img202603032301005} />
      </div>
    </div>
  );
}
...
function Frame34() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Roboto_Condensed:Bold',sans-serif] font-bold leading-[27.5px] relative shrink-0 text-[#798489] text-[28px] whitespace-nowrap">UX Pro</p>
    </div>
  );
}
...
function FreeIconVolumeLevelIndicator3() {
  return (
    <div className="h-[15px] overflow-clip relative shrink-0 w-[17px]" data-name="free-icon-volume-level-indicator-65061 1">
      <Group7 />
    </div>
...
function Frame36() {
  return (
    <div className="content-stretch flex gap-[5px] items-center justify-center relative shrink-0">
      <FreeIconVolumeLevelIndicator3 />
      <p className="font-['Roboto_Condensed:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#798489] text-[16px] whitespace-nowrap">мидл</p>
    </div>
  );
}

function FreeIconLayer6() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="free-icon-layer-1694011 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_118_1307)" id="free-icon-layer-1694011 1">
...
function Frame38() {
  return (
    <div className="content-stretch flex gap-[5px] items-center justify-center relative shrink-0">
      <FreeIconLayer7 />
      <p className="font-['Roboto_Condensed:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#798489] text-[16px] whitespace-nowrap">20 уроков</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="bg-[#38444a] flex-[1_0_0] min-h-px min-w-px relative rounded-[24px] w-[185px]">
      <div className="absolute h-[107px] left-[46px] opacity-60 top-[26px] w-[93px]" data-name="Снимок экрана 2026-03-03 в 23.01.00 2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img202603032301006} />
      </div>
    </div>
  );
}
...
function Frame42() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Roboto_Condensed:Bold',sans-serif] font-bold leading-[27.5px] relative shrink-0 text-[#798489] text-[28px] whitespace-nowrap">Типографика Pro</p>
    </div>
  );
}
...
function FreeIconVolumeLevelIndicator4() {
  return (
    <div className="h-[15px] overflow-clip relative shrink-0 w-[17px]" data-name="free-icon-volume-level-indicator-65061 1">
      <Group9 />
    </div>
...
function Frame44() {
  return (
    <div className="content-stretch flex gap-[5px] items-center justify-center relative shrink-0">
      <FreeIconVolumeLevelIndicator4 />
      <p className="font-['Roboto_Condensed:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#798489] text-[16px] whitespace-nowrap">мидл</p>
    </div>
  );
}

function FreeIconLayer8() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="free-icon-layer-1694011 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_118_1307)" id="free-icon-layer-1694011 1">
...
function Frame45() {
  return (
    <div className="content-stretch flex gap-[5px] items-center justify-center relative shrink-0">
      <FreeIconLayer8 />
      <p className="font-['Roboto_Condensed:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#798489] text-[16px] whitespace-nowrap">3 модуля</p>
    </div>
  );
}

function FreeIconLayer9() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="free-icon-layer-1694011 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_118_1307)" id="free-icon-layer-1694011 1">
...
function Frame46() {
  return (
    <div className="content-stretch flex gap-[5px] items-center justify-center relative shrink-0">
      <FreeIconLayer9 />
      <p className="font-['Roboto_Condensed:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#798489] text-[16px] whitespace-nowrap">18 уроков</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[36px] items-start left-[calc(50%+115.96px)] top-[20px] w-[1096.915px]" data-name="Frame">
      <Header />
      <MainContainer />
    </div>
  );
...
export default function Component() {
  return (
    <div className="relative size-full" data-name="курсы" style={{ backgroundImage: "linear-gradient(163.733deg, rgb(44, 52, 56) 14.367%, rgb(46, 57, 62) 147.74%)" }}>
      <Frame55 />
      <Frame />
    </div>
  );
