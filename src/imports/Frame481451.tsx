import svgPaths from "./svg-u7gh1bm86c";
  ...
  return (
    <div className="bg-[#343e42] h-[28.585px] relative rounded-[12296925px] shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex h-full items-center justify-center px-[11.727px] relative">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-medium leading-[15.392px] not-italic relative shrink-0 text-[#eef5ff] text-[10.261px] whitespace-nowrap">еще 3 дня</p>
      </div>
    </div>
  );
}
...
function Container() {
  return (
    <div className="bg-[#404d52] content-stretch flex gap-[10px] h-[55px] items-center justify-center px-[20px] relative rounded-[13.846px] shrink-0" data-name="Container">
      <p className="font-['Roboto_Condensed:Bold',sans-serif] font-bold leading-[27.5px] relative shrink-0 text-[#f4f5fc] text-[22px] whitespace-nowrap">Текущие</p>
      <Container1 />
    </div>
  );
}
...
function Container2() {
  return (
    <div className="bg-[#323d41] content-stretch flex h-[55px] items-center justify-center px-[20px] relative rounded-[13.846px] shrink-0" data-name="Container">
      <p className="font-['Roboto_Condensed:Bold',sans-serif] font-bold leading-[27.5px] relative shrink-0 text-[#798589] text-[22px] whitespace-nowrap">См. архив</p>
    </div>
  );
}
...
function Frame20() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-[572px]">
      <Container />
      <Container2 />
    </div>
  );
...
function RightSide() {
  return (
    <div className="absolute contents right-[5.51px] top-[6.51px]" data-name="Right Side">
      <Battery />
      <div className="absolute h-[4.119px] right-[16.54px] top-[6.51px] w-[5.737px]" data-name="Wifi">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.73731 4.11951">
          <path d={svgPaths.p39513ec0} fill="var(--fill-0, #2E2533)" id="Wifi" />
        </svg>
      </div>
...
function Group24() {
  return (
    <div className="h-[0.975px] relative w-[4.937px]">
...
function IPhone13ProMax() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[114.666px] left-[calc(50%+0.18px)] rounded-[7.865px] top-[calc(50%-0.67px)] w-[120.643px]" data-name="iPhone 13 Pro Max - 15" style={{ backgroundImage: "linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <div className="overflow-clip relative rounded-[inherit] size-full">
        ...
        <div className="absolute flex h-[0.975px] items-center justify-center left-[calc(100%-2.16px)] top-[calc(100%+99.14px)] w-[4.937px]">
          <div className="flex-none rotate-180">
            <Group24 />
          </div>
        </div>
        <div className="absolute flex h-[0.975px] items-center justify-center left-[calc(100%-2.16px)] top-[calc(100%+235.67px)] w-[4.937px]">
          <div className="flex-none rotate-180">
            <Group25 />
          </div>
        </div>
...
function Container10() {
  return (
    <div className="bg-[#3a474c] h-[28.585px] relative rounded-[12296925px] shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex h-full items-center justify-center px-[11.727px] relative">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-medium leading-[15.392px] not-italic relative shrink-0 text-[#eef5ff] text-[10.261px] whitespace-nowrap">+1250 XP</p>
      </div>
    </div>
  );
}
...
function RightSide1() {
  return (
    <div className="absolute contents right-[5.51px] top-[6.51px]" data-name="Right Side">
      ...
      <div className="absolute h-[4.119px] right-[16.54px] top-[6.51px] w-[5.737px]" data-name="Wifi">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.73731 4.11951">
          <path d={svgPaths.p31288880} fill="var(--fill-0, #2E2533)" id="Wifi" />
        </svg>
      </div>
      <div className="absolute h-[4.007px] right-[24.17px] top-[6.64px] w-[6.386px]" data-name="Mobile Signal">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.38574 4.00684">
...
function IPhone13ProMax1() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[114.666px] left-[calc(50%+0.18px)] rounded-[7.865px] top-[calc(50%+0.33px)] w-[120.643px]" data-name="iPhone 13 Pro Max - 15" style={{ backgroundImage: "linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <IOsStatusBarBlack2 />
        <p className="absolute capitalize font-['Craftwork_Grotesk:Bold',sans-serif] leading-[1.07] left-[9.28px] text-[6.095px] text-black top-[12.11px] tracking-[0.1524px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 700" }}>
          Notifications
...
function RightSide2() {
  return (
    <div className="absolute contents right-[5.51px] top-[6.51px]" data-name="Right Side">
      ...
      <div className="absolute h-[4.119px] right-[16.54px] top-[6.51px] w-[5.737px]" data-name="Wifi">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.73731 4.11951">
          <path d={svgPaths.p1c643450} fill="var(--fill-0, #2E2533)" id="Wifi" />
        </svg>
      </div>
      <div className="absolute h-[4.007px] right-[24.17px] top-[6.64px] w-[6.386px]" data-name="Mobile Signal">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.38574 4.00684">
  ...
  return (
    <div className="h-[13px] relative shrink-0 w-[12px]" data-name="free-icon-verify-12557027 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 13">
        <g clipPath="url(#clip0_181_589)" id="free-icon-verify-12557027 1">
          <path d={svgPaths.p37971580} fill="url(#paint0_linear_181_589)" id="Vector" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_181_589" x1="5.03886" x2="-0.208806" y1="5.84235" y2="14.2068">
            <stop stopColor="#FF6B21" />
            <stop offset="1" stopColor="#994014" />
          </linearGradient>
          <clipPath id="clip0_181_589">
...
export { Frame as ChallengePhone1, Frame1 as ChallengePhone2, Frame2 as ChallengePhone3 };