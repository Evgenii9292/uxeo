import svgPaths from "./svg-2s047mkxqi";
  ...
  return (
    <div className="relative shrink-0" data-name="Back Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[20px] items-center relative">
        ...
        <p className="font-['Roboto_Condensed:Bold',sans-serif] font-bold leading-[27.5px] relative shrink-0 text-[#f4f5fc] text-[26px] whitespace-nowrap">{`UX/UI `}</p>
        <p className="font-['Roboto_Condensed:Bold',sans-serif] font-bold leading-[27.5px] relative shrink-0 text-[#798589] text-[26px] whitespace-nowrap">Модули курса</p>
      </div>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="bg-[#38444a] flex-[1_0_0] min-h-px min-w-px relative rounded-[24px] w-full">
      <div className="absolute h-[161px] left-[26px] top-[38px] w-[186.121px]" data-name="Снимок экрана 2026-03-03 в 23.01.00 3">
...
function Frame12() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Roboto_Condensed:Bold',sans-serif] font-bold leading-[27.5px] relative shrink-0 text-[#f4f5fc] text-[28px] whitespace-nowrap">Основы UX/UI</p>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Roboto_Condensed:Bold',sans-serif] font-bold leading-[27.5px] relative shrink-0 text-[#f4f5fc] text-[28px] whitespace-nowrap">UX интерфейсов</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[24px] w-full">
      <div className="absolute h-[201px] left-[30px] top-[23px] w-[176px]" data-name="Снимок экрана 2026-03-03 в 23.01.00 2">
...
function Frame23() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Roboto_Condensed:Bold',sans-serif] font-bold leading-[27.5px] relative shrink-0 text-[#f4f5fc] text-[28px] whitespace-nowrap">UI Kit</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="relative size-full" data-name="Модули курса" style={{ backgroundImage: "linear-gradient(163.733deg, rgb(44, 52, 56) 14.367%, rgb(46, 57, 62) 147.74%)" }}>
      <Frame36 />
      <Frame />
    </div>
  );
