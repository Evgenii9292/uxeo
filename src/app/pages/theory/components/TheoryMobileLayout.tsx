      ...
      >
        ...
        <div className="flex items-center justify-center" style={{ height: '200px' }}>
          <img
            ...
            alt=""
            style={{ width: 150, height: 150, objectFit: "contain", filter: "brightness(0) invert(1)", maskImage: "linear-gradient(to bottom, black 0%, rgba(0,0,0,0.3) 100%)", WebkitMaskImage: "linear-gradient(to bottom, black 0%, rgba(0,0,0,0.3) 100%)", transform: `translateY(${mobileScrollY * 0.1}px)` }}
          />
        </div>
