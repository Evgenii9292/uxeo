...
export function ContinueDisabled() {
  return (
    <div className="bg-[#333d41] flex h-[59px] items-center justify-center px-[20.775px] rounded-[15px] shadow-[0px_4.155px_0px_0px_#212226] w-[194.662px]">
...
export function ContinueActive({ onClick }: { onClick: () => void }) {
  return (
    <button
...
export function ContinueCorrect({ onClick }: { onClick: () => void }) {
  return (
    <button
      onClick={() => { onClick(); playClick(); }}
...
export function CorrectFeedback({ showXp = true }: { showXp?: boolean }) {
  return (
    <div className="flex gap-[28px] items-center shrink-0">
      ...
      <p className="font-['Roboto_Condensed:Regular',sans-serif] font-normal leading-[1.2] text-[#f4f5fc] text-[18px] w-[398px]">
...
export function IncorrectFeedback() {
  return (
    <div className="flex gap-[28px] items-start shrink-0">
      ...
      <p className="font-['Roboto_Condensed:Regular',sans-serif] font-normal leading-[1.2] text-[#f4f5fc] text-[18px] w-[500px]">
